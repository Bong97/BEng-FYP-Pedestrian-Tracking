...
%     %writing for HOG
%     HOG_out_folder = 'C:\Users\Benjamin Ong\Desktop\Year 3\FYP_temp\ACF_AND_HOG\HOG_out\'; 
...
%     
%     %writing for ACF
%     ACF_out_folder = 'C:\Users\Benjamin Ong\Desktop\Year 3\FYP_temp\ACF_AND_HOG\ACF_out\'; 
% 
...
%     end
    ...
    ACF_AND_HOG_out_folder = 'C:\Users\Benjamin Ong\Desktop\Year 3\FYP_temp\ACF_AND_HOG\ACF_AND_HOG_out\Video_mum_4_Output\'; 
...
%         if num_detected_for_image > 1
%             max_size = 0;
%             max_ro = 1;
%             for i=1:num_detected
%                 tmp_size = bboxes(i,3) * bboxes(i,4);
...
myexcel = 'C:\Users\Benjamin Ong\Desktop\Year 3\FYP_temp\ACF_AND_HOG\ACF_AND_HOG_out\Video_Mum_4_Output\ACF_AND_HOG_predicted_mum_4_data.xlsx';
cell_array = [image_nameArray; Detection_count_array_per_image];
writecell(cell_array',myexcel)

BB_excel = 'C:\Users\Benjamin Ong\Desktop\Year 3\FYP_temp\ACF_AND_HOG\ACF_AND_HOG_out\Video_Mum_4_Output\ACF_AND_HOG_predicted_mum_4_bb.xlsx';
% cell_array = [image_nameArray; Detection_count_array_per_image];
